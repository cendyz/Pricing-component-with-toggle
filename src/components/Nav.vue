<template>
	<nav class="container py-[7rem] text-center">
		<h1 class="capitalize text-[3.5rem] text-neutral-500">our pricing</h1>
		<div class="flex items-center justify-center mt-[4rem] gap-x-[2.7rem]">
